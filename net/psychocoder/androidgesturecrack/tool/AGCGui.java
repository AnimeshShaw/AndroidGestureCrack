    ...
    private void initComponents() {
        ...
        crackButton.addActionListener((ActionEvent ae) -> {
            if (gestureFileLocTxtField.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Choose the dictionary file"
                        + "file", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
                ...
                try {
                    ...
                    gestureHashLabel.setText("Your Gesture Hash is: " + agc.getGestureHash());
                    gesturePatLabel.setText("Your Gesture Unlock Pattern is: " + agc.getGesturePattern());
                } catch (IOException ex) {
